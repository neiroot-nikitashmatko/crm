...
func (h *AnalyticsHandler) FailedDealsList(w http.ResponseWriter, r *http.Request) {
	h.items(w, r, func(ctx context.Context, fromMs int64, toMs int64) (any, error) {
		return h.service.FailedDealsList(ctx, fromMs, toMs)
	})
}

func (h *AnalyticsHandler) FailedLeadsList(w http.ResponseWriter, r *http.Request) {
	h.items(w, r, func(ctx context.Context, fromMs int64, toMs int64) (any, error) {
		return h.service.FailedLeadsList(ctx, fromMs, toMs)
	})
}
...
func (h *AnalyticsHandler) TradeProfitItems(w http.ResponseWriter, r *http.Request) {
	h.items(w, r, func(ctx context.Context, fromMs int64, toMs int64) (any, error) {
		return h.service.TradeProfitItems(ctx, fromMs, toMs)
	})
}
